...
void CompRenderer::renderWorldObject(const CRenderObject& obj)
{
	m_world_objects.push_back(obj);
}

void CompRenderer::renderUIObject(const CRenderObject& obj)
{
	m_ui_objects.push_back(obj);
}

void CompRenderer::update(typename CompRenderer::OutputData&)
{
